...
This repository showcases the complete User Interface (UI) for a lightweight, self-hosted automation tool, which I've named MiniZap. Think of it as the dashboard you'd use to manage simple "If This, Then That" workflows, similar to tools like Zapier. For example, it's designed to show workflows like "Gmail to Slack Alert" or "GitHub Star to Discord" being managed from a single place.
